...
The front panel requires a \num{10}-turn potentiometer. This needs to be correctly wired to a \href{https://www.molex.com/content/dam/molex/molex-dot-com/products/automated/en-us/productspecificationpdf/100/1007/PS-10-07-001.pdf?inline}{Molex KK 254} connector on the PCB using three twisted stranded wires. Each \qty{18}{\cm} in length. The colour code of these wires is
\begin{itemize}
...
Once the wires are soldered in and before shrinking the shrink tubing, the result should look like shown in figure \ref{fig:potentiometer_assemby}. Do note the twisted stranded wires as well.
